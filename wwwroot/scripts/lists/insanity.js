window.insanity = {
	...
	items: [
		...
		'You think you develop a knack for writing or painting bleak works of art. Meaning, you try your best, but the insanity grants no positive modifiers on checks to actually make the work of art. (Inspired by Kyle from high school)',
		...
		'There\'s a cold draft across the back of your neck. "DAMMIT! Would somebody close the windows!"',
		...
		'You have an extreme phobia to green paint. For example, a portrait of a horse in a field (green painted grass!!!) is wholly traumatizing to you.',
		'You swear up and down that every footstep you take sounds like you\'re walking on dry, crunchy leaves. "How do none of you hear that??!"',
		...
		'You have a form of synesthesia, where you find bright colors to generate the sensation of a pleasant taste. Despite numerous failed attempts (and learning the hard way) you have an irrational desire to eat or taste bright objects, to see if they really do taste like you imagine.',
		'Staring. You misinterpret people looking in your direction as staring directly at you.',
		'1 out of 100 people you encounter appear appear dead and rotting from a grisly death. There may or may not be a pattern to this, but it will surely drive you mad to discover what that pattern may be.',
		'The "Deep" State. Everyone has gills or Lovecraftian "fishy" features (extra eyelids, finger-tentacles, webbed toes, etc) that they keep hidden from you, you only see them out of the corner of your eye, when they think you aren\'t looking. People in positions of power or authority seem more likely to trigger this hallucination.',
		'You hear a form of music, always, but are unable to pin it down or repeat it to anyone, no matter how hard you try. Regular sounds often have musical qualities or intriguing rhythms that, like ear-worms, you can\'t get out of your head when you hear them.',
		'There is someone, or something, always watching you.. you will never be able to see them, but they are there, plotting something against you. People that you know will slowly become suborned by the Watcher, doing it\'s bidding, and helping to spy on you for its unknowable ends.',
		'The afflicted thinks the landscape around them is alien to the world they know',
		'The afflicted thinks there\'s some sort of monster of parasite inside them',
		'The afflicted sees horrors walking among mortal men',
		'The afflicted sees each creature as some twisted form of themselves.',
		'The afflicted always sees movement on the periphery of their vision.',
		'The afflicted hears a distant song they remember loving. They cannot remember the words, and the singer is too far away to discern them.',
		'The afflicted feels cold appendages tracing up and down their torso.',
		'The afflicted sees all flat surfaces as mirrors.',
	]
}